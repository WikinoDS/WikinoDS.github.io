---
title: "Regressão Linear Aplicada à Séries Temporais com Python"
format: html
...
dummies_sazo = pd.get_dummies(pd.DataFrame({"mes": df_cv.index.month}), columns=["mes"]).astype(int)
